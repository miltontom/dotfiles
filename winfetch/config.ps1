...
function info_custom_time {
    return @{
        title = "Time"
        content = (Get-Date).ToString("dd/MMM/yy hh:mm tt")
    }
}

function info_custom_colorbar_circle {
    return @{
        title = ""
        content = "`e[30m  `e[31m  `e[32m  `e[33m  `e[34m  `e[35m  `e[36m  `e[37m`e[0m"
    }
}
